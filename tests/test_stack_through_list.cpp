...
TEST(TestStackThroughListLib, throw_negative_size) {
    // Arrange

    ASSERT_ANY_THROW(StackThroughList<int> stack(-2));
}
TEST(TestStackThroughListLib, size_constructor) {
    // Arrange
    StackThroughList<int> stack(2);

    ASSERT_NO_THROW(StackThroughList<int> stack(2));
    EXPECT_EQ(2, stack.get_size());
    EXPECT_EQ(-1, stack.get_top());
}
TEST(TestStackThroughListLib, copy_constructor) {
    // Arrange
    StackThroughList<int> stack_1(2), stack_2(stack_1);
...
TEST(TestStackThroughListLib, stack_is_empty_false) {
    // Arrange
    StackThroughList<int> stack_1(2);
    stack_1.push(2);

    EXPECT_EQ(false, stack_1.is_empty());
}
TEST(TestStackThroughListLib, stack_is_full_true) {
    // Arrange
    StackThroughList<int> stack_1(2);
    stack_1.push(2);
    stack_1.push(3);
...
TEST(TestStackThroughListLib, stack_is_full_false) {
    StackThroughList<int> stack_1(2);
    stack_1.push(2);
...
TEST(TestStackThroughListLib, top_in_stack) {
    // Arrange
    StackThroughList<int> stack_1(3);
    stack_1.push(3);
    stack_1.push(7);
    stack_1.pop();
    stack_1.push(8);
...
TEST(TestStackThroughListLib, push_in_full_stack) {
    // Arrange
    StackThroughList<int> stack_1(2);
    stack_1.push(2);
    stack_1.push(2);
