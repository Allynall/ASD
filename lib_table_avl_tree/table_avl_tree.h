...
template <class TKey, class TValue>
TableAVLTree<TKey, TValue>::TableAVLTree() : _rows() {}

template <class TKey, class TValue>
bool TableAVLTree<TKey, TValue>::isEmpty() const noexcept {
...
template <class TKey, class TValue>
const TValue& TableAVLTree<TKey, TValue>::found(const TKey& key) const {
...
template <class TKey, class TValue>
void TableAVLTree<TKey, TValue>::print() const noexcept {
    if (isEmpty()) {
